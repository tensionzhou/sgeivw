 ...
 */
    ...
    require_once($CFG->dirroot . '/sglib/user.php');
...
/// If the site is currently under maintenance, then print a message
    ...
    if($_GET['guide']=='finished')
    {
    	global $DB;
    	$DB->set_field('user', 'guided', '1',array('id'=> $USER->id));
    }

    if (isloggedin()) {
        add_to_log(SITEID, 'course', 'view', 'view.php?id='.SITEID, SITEID);
        //SmarkGlobal Allen Li
        //if logged in and the user is the first time to system,lead him to 
        checkGuided();
        //Some how hacking 0.0
    }
